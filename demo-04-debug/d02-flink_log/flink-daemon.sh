...
FLINK_LOG_FILENAME=flink-${FLINK_IDENT_STRING}-${DAEMON}-${id}-${HOSTNAME}
FLINK_LOG_PREFIX="${FLINK_LOG_DIR}/${FLINK_LOG_FILENAME}"
...
log_setting+=("-Dsuyh.log.dir=${FLINK_LOG_DIR}")
log_setting+=("-Dsuyh.log.filename=${FLINK_LOG_FILENAME}")
